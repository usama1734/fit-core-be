...
router.post('/', requireRole(ROLES.ADMIN), validate(createPlanSchema), asyncHandler(planController.create));
router.patch('/:id', requireRole(ROLES.ADMIN), validate(updatePlanSchema), asyncHandler(planController.update));
